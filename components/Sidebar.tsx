...
const nav = [
  ...
  { href: '/competitive-intelligence', label: 'Competitive Intel', icon: '⚡' },
  ...
  { href: '/content-briefs', label: 'Content Briefs', icon: '📝' },
...
export default function Sidebar() {
  ...
  return (
    <aside className="app-sidebar">
      ...
      <div className={`sidebar-menu-panel ${isMenuOpen ? 'is-open' : ''}`}>
